...
const SavedExcercise = () => {
    
            const {selectedExercisesTwo} = useContext(LibraryContext);
        
        const totalExercises = selectedExercisesTwo.length;
        
        const totalMinutes = selectedExercisesTwo.reduce(
          (total, exercise) => total + Number(exercise.duration) ,
          0
        );
        
        const totalCalories = selectedExercisesTwo.reduce(
